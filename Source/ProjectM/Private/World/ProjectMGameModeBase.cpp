...
AProjectMGameModeBase::AProjectMGameModeBase()
{
	...
	static ConstructorHelpers::FClassFinder<ACharacterController> PlayerController(
		TEXT("/Game/Blueprints/Player/BP_CharacterController"));
...
void AProjectMGameModeBase::HandleStartingNewPlayer_Implementation(APlayerController* _newPlayer)
{
	...
	float _TempX = UKismetMathLibrary::RandomBool()
	...
	APlayerBase* _tempPlayer = Cast<APlayerBase>(
